...
class Order(Resource):
    ...
    def post(cls):
        ...
        # the following error handling is advised by Stripe,
        # although the handling implementations are identical,
        # we choose to specify them separately just to give the students a
        # better idea what we can expect
